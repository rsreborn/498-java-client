...
public class Class23_Sub4_Sub10 extends Class23_Sub4
{
	...
	static final void method302(int i, int i_8_, Class105_Sub1 class105_sub1) {
		...
		if (Class89.aClass23_Sub5_1514 != null) {
			Class89.aClass23_Sub5_1514.pos = 5 + 8 * i;
			int i_9_ = Class89.aClass23_Sub5_1514.readUIntBE();
			int i_10_ = Class89.aClass23_Sub5_1514.readUIntBE();
		...
		if (i_21_ == 1000) {
			if (i == 0) {
				...
				if ((i_22_ ^ 0xffffffff) != -1) {
					...
					anIntArrayArray3051 = new int[class23_sub5.readUByte()][4];
					for (int i_23_ = 0; i_23_ < anIntArrayArray3051.length; i_23_++) {
						anIntArrayArray3051[i_23_][0] = class23_sub5.getUShortBE();
						anIntArrayArray3051[i_23_][1] = class23_sub5.readUByte() << 4;
						anIntArrayArray3051[i_23_][2] = class23_sub5.readUByte() << 4;
						anIntArrayArray3051[i_23_][3] = class23_sub5.readUByte() << 4;
					}
				}
			}
			anInt3043++;
