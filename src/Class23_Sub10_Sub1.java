...
public class Class23_Sub10_Sub1 extends Class23_Sub10
{
	...
	private boolean aBoolean3559;
	private int anInt3560;
	private int anInt3561;
	private int anInt3562;
	private int anInt3563;
	
	final synchronized void method506(int[] is, int i, int i_0_) {
		if (anInt3549 == 0 && anInt3563 == 0) {
			method507(i_0_);
		} else {
			Class23_Sub6_Sub1 class23_sub6_sub1 = (Class23_Sub6_Sub1) aClass23_Sub6_2278;
			int i_1_ = anInt3554 << 8;
			int i_2_ = anInt3558 << 8;
			int i_3_ = class23_sub6_sub1.aByteArray3544.length << 8;
			int i_4_ = i_2_ - i_1_;
			if (i_4_ <= 0) {
				anInt3562 = 0;
			}
			...
			if (anInt3562 < 0) {
				if (aBoolean3559) {
					if (anInt3550 < 0) {
						i_5_ = method521(is, i_5_, i_1_, i_0_, class23_sub6_sub1.aByteArray3544[anInt3554]);
						if (anInt3553 >= i_1_) {
							return;
						}
					...
					for (;;) {
						i_5_ = method520(is, i_5_, i_2_, i_0_, class23_sub6_sub1.aByteArray3544[anInt3558 - 1]);
						if (anInt3553 < i_2_) {
							break;
						}
					...
					for (;;) {
						i_5_ = method521(is, i_5_, i_1_, i_0_, class23_sub6_sub1.aByteArray3544[anInt3558 - 1]);
						if (anInt3553 >= i_1_) {
							break;
						}
					...
					for (;;) {
						i_5_ = method520(is, i_5_, i_2_, i_0_, class23_sub6_sub1.aByteArray3544[anInt3554]);
						if (anInt3553 < i_2_) {
							break;
						}
	...
	private static final int method509(byte[] bs, int[] is, int i, int i_8_, int i_9_, int i_10_, int i_11_, int i_12_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i >>= 8;
		i_12_ >>= 8;
		i_9_ <<= 2;
	...
	static final Class23_Sub10_Sub1 method510(Class23_Sub6_Sub1 class23_sub6_sub1, int i, int i_13_) {
		if (class23_sub6_sub1.aByteArray3544 == null || class23_sub6_sub1.aByteArray3544.length == 0) {
			return null;
		}
		return new Class23_Sub10_Sub1(class23_sub6_sub1, (int) ((long) class23_sub6_sub1.anInt3547 * 256L * (long) i / (long) (100 * Class32.anInt498)), i_13_ << 6);
	}
	...
	final synchronized void method507(int i) {
		...
		int i_16_ = class23_sub6_sub1.aByteArray3544.length << 8;
	...
	private final boolean method511() {
		int i = anInt3549;
		int i_20_;
		int i_21_;
		if (i == -2147483648) {
	...
	private static final int method514(byte[] bs, int[] is, int i, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i >>= 8;
		i_26_ >>= 8;
		i_23_ <<= 2;
	...
	private static final int method516(int i, int i_28_, byte[] bs, int[] is, int i_29_, int i_30_, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_36_, int i_37_) {
	...
	private static final int method517(int i, int i_38_, byte[] bs, int[] is, int i_39_, int i_40_, int i_41_, int i_42_, int i_43_, int i_44_, int i_45_, int i_46_, int i_47_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_48_, int i_49_) {
	...
	private static final int method518(byte[] bs, int[] is, int i, int i_50_, int i_51_, int i_52_, int i_53_, int i_54_, int i_55_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i >>= 8;
		i_55_ >>= 8;
		i_51_ <<= 2;
		i_52_ <<= 2;
	...
	private final int method520(int[] is, int i, int i_57_, int i_58_, int i_59_) {
		while (anInt3563 > 0) {
	...
	private final int method521(int[] is, int i, int i_61_, int i_62_, int i_63_) {
		while (anInt3563 > 0) {
	...
	private static final int method522(int i, byte[] bs, int[] is, int i_65_, int i_66_, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i_65_ >>= 8;
		i_71_ >>= 8;
		i_67_ <<= 2;
		i_68_ <<= 2;
	...
	final synchronized void method524(int i) {
		int i_72_ = ((Class23_Sub6_Sub1) aClass23_Sub6_2278).aByteArray3544.length << 8;
		if (i < -1) {
			i = -1;
		}
		if (i > i_72_) {
	...
	private static final int method525(int i, int i_73_, byte[] bs, int[] is, int i_74_, int i_75_, int i_76_, int i_77_, int i_78_, int i_79_, int i_80_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_81_, int i_82_) {
	...
	final boolean method527() {
		if (anInt3553 >= 0 && anInt3553 < ((Class23_Sub6_Sub1) aClass23_Sub6_2278).aByteArray3544.length << 8) {
			return false;
		}
		return true;
	}
	...
	static final Class23_Sub10_Sub1 method529(Class23_Sub6_Sub1 class23_sub6_sub1, int i, int i_83_, int i_84_) {
		if (class23_sub6_sub1.aByteArray3544 == null || class23_sub6_sub1.aByteArray3544.length == 0) {
			return null;
		}
		return new Class23_Sub10_Sub1(class23_sub6_sub1, i, i_83_, i_84_);
	}
	
	private static final int method530(int i, int i_85_, byte[] bs, int[] is, int i_86_, int i_87_, int i_88_, int i_89_, int i_90_, int i_91_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_92_, int i_93_) {
	...
	private static final int method531(int i, int i_94_) {
		if (i_94_ < 0) {
			return -i;
		}
		return (int) ((double) i * Math.sqrt((double) i_94_ * 1.220703125E-4) + 0.5);
	}
	
	private final void method532() {
		if (anInt3563 != 0) {
			if (anInt3549 == -2147483648) {
				anInt3549 = 0;
			}
	...
	private static final int method533(int i, byte[] bs, int[] is, int i_95_, int i_96_, int i_97_, int i_98_, int i_99_, int i_100_, int i_101_, int i_102_, int i_103_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i_95_ >>= 8;
		i_103_ >>= 8;
		i_97_ <<= 2;
		i_98_ <<= 2;
	...
	private static final int method534(int i, int i_104_) {
		if (i_104_ < 0) {
			return i;
		}
		return (int) ((double) i * Math.sqrt((double) (16384 - i_104_) * 1.220703125E-4) + 0.5);
	}
	
	private static final int method535(int i, int i_105_, byte[] bs, int[] is, int i_106_, int i_107_, int i_108_, int i_109_, int i_110_, int i_111_, int i_112_, int i_113_, int i_114_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_115_, int i_116_) {
	...
	private static final int method537(int i, int i_117_, byte[] bs, int[] is, int i_118_, int i_119_, int i_120_, int i_121_, int i_122_, int i_123_, int i_124_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_125_, int i_126_) {
	...
	private final synchronized void method538(int i, int i_127_) {
		anInt3549 = i;
		anInt3560 = i_127_;
		anInt3563 = 0;
		method546();
	...
	private static final int method539(int i, byte[] bs, int[] is, int i_128_, int i_129_, int i_130_, int i_131_, int i_132_, int i_133_, int i_134_, int i_135_, int i_136_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i_128_ >>= 8;
		i_136_ >>= 8;
		i_130_ <<= 2;
		i_131_ <<= 2;
	...
	private static final int method540(byte[] bs, int[] is, int i, int i_137_, int i_138_, int i_139_, int i_140_, int i_141_, int i_142_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i >>= 8;
		i_142_ >>= 8;
		i_138_ <<= 2;
		i_139_ <<= 2;
	...
	private static final int method541(int i, int i_143_, byte[] bs, int[] is, int i_144_, int i_145_, int i_146_, int i_147_, int i_148_, int i_149_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_150_, int i_151_) {
	...
	private static final int method542(int i, int i_152_, byte[] bs, int[] is, int i_153_, int i_154_, int i_155_, int i_156_, int i_157_, int i_158_, int i_159_, Class23_Sub10_Sub1 class23_sub10_sub1, int i_160_, int i_161_) {
	...
	private final synchronized void method544(int i) {
		method538(i, method513());
	}
	
	private static final int method545(int i, byte[] bs, int[] is, int i_162_, int i_163_, int i_164_, int i_165_, int i_166_, int i_167_, int i_168_, Class23_Sub10_Sub1 class23_sub10_sub1) {
		i_162_ >>= 8;
		i_168_ >>= 8;
		i_164_ <<= 2;
		i_165_ <<= 2;
	...
	final int method505() {
		...
		i = (i ^ i >> 31) + (i >>> 31);
		if (anInt3562 == 0) {
			i -= i * anInt3553 / (((Class23_Sub6_Sub1) aClass23_Sub6_2278).aByteArray3544.length << 8);
		} else if (anInt3562 >= 0) {
			i -= i * anInt3554 / ((Class23_Sub6_Sub1) aClass23_Sub6_2278).aByteArray3544.length;
		}
		if (i > 255) {
			return 255;
		}
	...
	private Class23_Sub10_Sub1(Class23_Sub6_Sub1 class23_sub6_sub1, int i, int i_174_) {
		aClass23_Sub6_2278 = class23_sub6_sub1;
		anInt3554 = class23_sub6_sub1.anInt3548;
		anInt3558 = class23_sub6_sub1.anInt3546;
		aBoolean3559 = class23_sub6_sub1.aBoolean3545;
		anInt3550 = i;
		anInt3549 = i_174_;
		anInt3560 = 8192;
		anInt3553 = 0;
	...
	private Class23_Sub10_Sub1(Class23_Sub6_Sub1 class23_sub6_sub1, int i, int i_175_, int i_176_) {
		aClass23_Sub6_2278 = class23_sub6_sub1;
		anInt3554 = class23_sub6_sub1.anInt3548;
		anInt3558 = class23_sub6_sub1.anInt3546;
		aBoolean3559 = class23_sub6_sub1.aBoolean3545;
