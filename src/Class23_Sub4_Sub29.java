...
public class Class23_Sub4_Sub29 extends Class23_Sub4
{
	...
	final void method255(Buffer class23_sub5, int i, int i_14_) {
		anInt3371++;
		if ((i ^ 0xffffffff) == -1) {
			anInt3370 = class23_sub5.readUByte();
			anIntArrayArray3356 = new int[class23_sub5.readUByte()][2];
			for (int i_15_ = 0; i_15_ < anIntArrayArray3356.length; i_15_++) {
				anIntArrayArray3356[i_15_][0] = class23_sub5.getUShortBE();
				anIntArrayArray3356[i_15_][1] = class23_sub5.getUShortBE();
			}
		}
		if (i_14_ != 1000) {
			method384((byte) -22);
