...
public class Class38_Sub5 extends Class38 {
	...
	static final void method1068(byte b, RSString class16) {
		Class23_Sub21 class23_sub21 = Class71_Sub1.method1269(class16,
				(byte) 79);
		anInt2588++;
		if (class23_sub21 != null) {
			Class75.anInt1381 = Class29.anInt445 - -Class38_Sub7.anInt2697
					+ -class23_sub21.anInt2415;
			Class68.anInt1203 = -Class102.anInt1702 + class23_sub21.anInt2412;
			int i = -111 % ((b - -20) / 54);
			int i_0_ = Class68.anInt1203
					+ -(int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt1128 / Class107.aDouble1838);
			int i_1_ = Class68.anInt1203
					+ (int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt1128 / Class107.aDouble1838);
			if (i_0_ < 0) {
				Class68.anInt1203 = (int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt1128 / Class107.aDouble1838);
			}
			if ((i_1_ ^ 0xffffffff) < (ISAACCipher.anInt1238 ^ 0xffffffff)) {
				Class68.anInt1203 = -(int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt1128 / Class107.aDouble1838)
						+ ISAACCipher.anInt1238;
			}
			int i_2_ = -(int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt999 / Class107.aDouble1838)
					+ Class75.anInt1381;
			int i_3_ = Class75.anInt1381
					- -(int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt999 / Class107.aDouble1838);
			if (i_2_ < 0) {
			...
			if (Class38_Sub7.anInt2697 < i_3_) {
				Class75.anInt1381 = Class38_Sub7.anInt2697
						- (int) ((double) Class23_Sub13_Sub12.aClass64_3967.anInt999 / Class107.aDouble1838);
			}
		}
	}
	...
	final void method1069(int i, int i_4_, int i_5_, int i_6_, int i_7_) {
		...
		aDouble2595 = Math.sqrt(aDouble2577 * aDouble2577 + aDouble2590
				* aDouble2590);
		if (!aBoolean2599) {
			aDouble2592 = -aDouble2595
					* Math.tan(0.02454369 * (double) anInt2574);
		}
		aDouble2568 = (-(d * aDouble2592) + (-aDouble2573 + (double) i_6_))
				* 2.0 / (d * d);
	}

	final void method995(int i, int i_10_, int i_11_, int i_12_, int i_13_,
			int i_14_, int i_15_, int i_16_, long l) {
		Class38_Sub1 class38_sub1 = method1070(36);
		anInt2606++;
		if (class38_sub1 != null) {
			class38_sub1.method995(i, i_10_, i_11_, i_12_, i_13_, i_14_, i_15_,
					i_16_, l);
	...
	private final Class38_Sub1 method1070(int i) {
		Class23_Sub13_Sub17 class23_sub13_sub17 = Class23_Sub13_Sub21
				.method827(anInt2598, (byte) -118);
		anInt2591++;
		Class38_Sub1 class38_sub1 = class23_sub13_sub17.method787(anInt2578,
				(byte) 95);
		if (class38_sub1 == null) {
			return null;
		}
	...
	final void method1072(int i, int i_19_) {
		...
		aDouble2573 += aDouble2592 * (double) i + (double) i
				* (aDouble2568 * 0.5) * (double) i;
		aBoolean2599 = true;
			...
			if (aClass23_Sub13_Sub22_2594 != null) {
				...
				while (anInt2572 > aClass23_Sub13_Sub22_2594.anIntArray4204[anInt2578]) {
					...
					if (aClass23_Sub13_Sub22_2594.anIntArray4203.length <= anInt2578) {
						...
						if ((anInt2578 ^ 0xffffffff) > -1
								|| (aClass23_Sub13_Sub22_2594.anIntArray4203.length ^ 0xffffffff) >= (anInt2578 ^ 0xffffffff)) {
							anInt2578 = 0;
						}
					}
				}
	...
	static final void method1074(int i, boolean bool) {
		...
		for (int i_21_ = 0; (i_21_ ^ 0xffffffff) > (i_20_ ^ 0xffffffff); i_21_++) {
			...
			//start custom maps
//			try { 
//				bs_22_ = MapDecompresser.grabMapFile(Class23_Sub4_Sub33.anIntArray3431[i_21_]);
//			} catch (IOException e) {
//				e.printStackTrace();
//			}
			//end custom maps
			if (bs_22_ != null) {
				int i_23_ = -Class58.anInt903
						+ (Class23_Sub13_Sub13.anIntArray3996[i_21_] & 0xff)
						* 64;
				int i_24_ = -Class42.anInt662
						+ (Class23_Sub13_Sub13.anIntArray3996[i_21_] >> 8) * 64;
				Class48.method1150((byte) -107);
				Class23_Sub13_Sub12.method748(i_23_, Class4.aClass72Array85,
						i_24_, (byte) -103, bool, bs_22_);
			}
		}
	}

	Class38_Sub5(int i, int i_25_, int i_26_, int i_27_, int i_28_, int i_29_,
	...
	static {
		aClass16_2571 = Class38_Sub6.method1076((byte) 86,
