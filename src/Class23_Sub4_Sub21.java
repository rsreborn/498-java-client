			...
			do {
				do {
					if ((i_14_ ^ 0xffffffff) != -1) {
						...
						anInt3250 = class23_sub5.method476((byte) -101);
						break while_58_;
					}
					anInt3252 = class23_sub5.method476((byte) -113);
					break while_58_;
				} while (false);
				anInt3254 = class23_sub5.method476((byte) -116);
				break while_58_;
			} while (false);
			anInt3249 = class23_sub5.method476((byte) -107);
		} while (false);
		anInt3246++;
		if (i_13_ != 1000) {
			aClass16_3241 = null;
