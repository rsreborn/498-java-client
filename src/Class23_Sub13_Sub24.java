...
public class Class23_Sub13_Sub24 extends Class23_Sub13
{
	...
	private final void method850(int i, int i_7_, int i_8_, Buffer class23_sub5) {
		anInt4269++;
		if (i == 1) {
			anInt4274 = class23_sub5.method471(111);
	...
	static final Class23_Sub13_Sub11 method853(int i, int i_15_) {
		int i_16_ = 44 / ((i - 56) / 60);
		anInt4273++;
		Class23_Sub13_Sub11 class23_sub13_sub11 = (Class23_Sub13_Sub11) Class1.aClass5_58.method62(-62, (long) i_15_);
		...
		class23_sub13_sub11 = new Class23_Sub13_Sub11();
		class23_sub13_sub11.anInt3926 = i_15_;
		if (bs != null) {
		...
		if (class23_sub13_sub11.anInt3915 != -1) {
			class23_sub13_sub11.method740(method853(-80, class23_sub13_sub11.anInt3915), method853(123, class23_sub13_sub11.anInt3894), (byte) -22);
		}
		if (!Class23_Sub4_Sub27.aBoolean3341 && class23_sub13_sub11.aBoolean3908) {
			class23_sub13_sub11.aBoolean3900 = false;
			class23_sub13_sub11.anInt3943 = 0;
			class23_sub13_sub11.aClass16Array3945 = null;
			class23_sub13_sub11.aClass16_3902 = Class87_Sub1.aClass16_2789;
