...
public class Class69 {
	...
	static RSString aClass16_1217 = Class38_Sub6.method1076((byte) 86,
			"document)3cookie=(R");
	...
	static final void method1257(boolean bool) {
		anInt1207++;
		int i = (Class105.aClass38_Sub7_Sub2_1812.anInt2674 >> 7)
				+ Class42.anInt662;
		int i_0_ = (Class105.aClass38_Sub7_Sub2_1812.anInt2659 >> 7)
				- -Class58.anInt903;
		...
		if (Class23_Sub4_Sub39.anInt3519 == 1 && i >= 3139 && i <= 3199
				&& i_0_ >= 3008 && i_0_ <= 3062) {
			Class23_Sub4_Sub39.anInt3519 = 0;
		}
		if (bool != true) {
	...
	static final byte[] method1258(int i, byte[] bs) {
		...
		anInt1208++;
		int i_1_ = class23_sub5.readUByte();
		int i_2_ = class23_sub5.readUIntBE();
		if (i_2_ < i
				|| (Class23_Sub4_Sub36.anInt3466 ^ 0xffffffff) != -1
				&& (Class23_Sub4_Sub36.anInt3466 ^ 0xffffffff) > (i_2_ ^ 0xffffffff)) {
			throw new RuntimeException();
		}
		if ((i_1_ ^ 0xffffffff) != -1) {
			int i_3_ = class23_sub5.readUIntBE();
			if (i_3_ < 0 || (Class23_Sub4_Sub36.anInt3466 ^ 0xffffffff) != -1
					&& i_3_ > Class23_Sub4_Sub36.anInt3466) {
				// throw new RuntimeException();
				return new byte[100];
			}
			if (i_3_ >= 2000000) {
