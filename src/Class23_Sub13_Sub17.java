...
public class Class23_Sub13_Sub17 extends Class23_Sub13
{
	...
	private final void method791(Buffer class23_sub5, int i, int i_9_) {
		if (i == 1) {
			anInt4062 = class23_sub5.readShortBE();
		} else if (i != 2) {
			if (i == 4) {
				anInt4058 = class23_sub5.readShortBE();
			} else if (i != 5) {
				if (i == 6) {
					anInt4067 = class23_sub5.readShortBE();
				} else if (i == 7) {
					anInt4057 = class23_sub5.readByte();
				} else if (i != 8) {
					if (i != 9) {
						if (i != 40) {
							if (i == 41) {
								...
								for (int i_11_ = 0; (i_10_ ^ 0xffffffff) < (i_11_ ^ 0xffffffff); i_11_++) {
									aShortArray4050[i_11_] = (short) class23_sub5.readShortBE();
									aShortArray4070[i_11_] = (short) class23_sub5.readShortBE();
								}
							}
						} else {
							...
							for (int i_13_ = 0; (i_13_ ^ 0xffffffff) > (i_12_ ^ 0xffffffff); i_13_++) {
								aShortArray4068[i_13_] = (short) class23_sub5.readShortBE();
								aShortArray4052[i_13_] = (short) class23_sub5.readShortBE();
							}
						}
					} else {
						aBoolean4054 = true;
					...
					anInt4060 = class23_sub5.readByte();
				}
			} else {
				anInt4076 = class23_sub5.readShortBE();
			}
		} else {
			anInt4059 = class23_sub5.readShortBE();
		}
		anInt4064++;
		if (i_9_ <= 98) {
			aBoolean4054 = true;
