...
{
	private Class41 aClass41_1574;
	private Class41 aClass41_1575;
	private int[] anIntArray1576 = new int[5];
	private Class41 aClass41_1577;
	private static int[] anIntArray1578;
	private Class41 aClass41_1579;
	private Class41 aClass41_1580;
	private Class12 aClass12_1581;
	private int[] anIntArray1582;
	protected int anInt1583;
	private Class41 aClass41_1584;
	private static int[] anIntArray1585 = new int[32768];
	private Class41 aClass41_1586;
	private int[] anIntArray1587 = new int[5];
	private int anInt1588;
	private Class41 aClass41_1589;
	private int anInt1590;
	protected int anInt1591;
	private Class41 aClass41_1592;
	private static int[] anIntArray1593;
	private static int[] anIntArray1594;
	private static int[] anIntArray1595;
	private static int[] anIntArray1596;
	private static int[] anIntArray1597;
	private static int[] anIntArray1598;
	
	final void method1461(Buffer class23_sub5) {
		...
		i = class23_sub5.method461(-1797813752);
		if (i != 0) {
			class23_sub5.position--;
		...
		for (int i_0_ = 0; i_0_ < 10; i_0_++) {
			int i_1_ = class23_sub5.method432((byte) 29);
			if (i_1_ == 0) {
				break;
			}
			anIntArray1576[i_0_] = i_1_;
			anIntArray1582[i_0_] = class23_sub5.method459(true);
			anIntArray1587[i_0_] = class23_sub5.method432((byte) 19);
		}
		anInt1588 = class23_sub5.method432((byte) 40);
		anInt1590 = class23_sub5.method432((byte) 113);
		anInt1591 = class23_sub5.method476((byte) -127);
		anInt1583 = class23_sub5.method476((byte) -98);
		aClass12_1581 = new Class12();
		aClass41_1584 = new Class41();
		aClass12_1581.method117(class23_sub5, aClass41_1584);
	}
	
	private final int method1462(int i, int i_2_, int i_3_) {
		if (i_3_ == 1) {
			if ((i & 0x7fff) < 16384) {
				return i_2_;
			}
	...
	final int[] method1463(int i, int i_4_) {
		Class3.method54(anIntArray1578, 0, i);
		if (i_4_ < 10) {
		...
		if (aClass41_1586 != null) {
			...
			i_5_ = (int) ((double) (aClass41_1586.anInt633 - aClass41_1586.anInt636) * 32.768 / d);
			i_6_ = (int) ((double) aClass41_1586.anInt636 * 32.768 / d);
		}
		int i_8_ = 0;
		int i_9_ = 0;
		int i_10_ = 0;
		if (aClass41_1592 != null) {
			...
			i_8_ = (int) ((double) (aClass41_1592.anInt633 - aClass41_1592.anInt636) * 32.768 / d);
			i_9_ = (int) ((double) aClass41_1592.anInt636 * 32.768 / d);
		}
		for (int i_11_ = 0; i_11_ < 5; i_11_++) {
			if (anIntArray1576[i_11_] != 0) {
				anIntArray1595[i_11_] = 0;
				anIntArray1594[i_11_] = (int) ((double) anIntArray1587[i_11_] * d);
				anIntArray1597[i_11_] = (anIntArray1576[i_11_] << 14) / 100;
				anIntArray1598[i_11_] = (int) ((double) (aClass41_1589.anInt633 - aClass41_1589.anInt636) * 32.768 * Math.pow(1.0057929410678534, (double) anIntArray1582[i_11_]) / d);
				anIntArray1596[i_11_] = (int) ((double) aClass41_1589.anInt636 * 32.768 / d);
			}
		}
		...
		if (anInt1588 > 0 && anInt1590 > 0) {
			int i_27_ = (int) ((double) anInt1588 * d);
			for (int i_28_ = i_27_; i_28_ < i; i_28_++)
				anIntArray1578[i_28_] += anIntArray1578[i_28_ - i_27_] * anInt1590 / 100;
		}
		if (aClass12_1581.anIntArray236[0] > 0 || aClass12_1581.anIntArray236[1] > 0) {
			aClass41_1584.method1110();
			int i_29_ = aClass41_1584.method1112(i + 1);
			int i_30_ = aClass12_1581.method114(0, (float) i_29_ / 65536.0F);
			int i_31_ = aClass12_1581.method114(1, (float) i_29_ / 65536.0F);
			if (i >= i_30_ + i_31_) {
				int i_32_ = 0;
				int i_33_ = i_31_;
				if (i_33_ > i - i_30_) {
				...
				for (/**/; i_32_ < i_33_; i_32_++) {
					int i_34_ = (int) ((long) anIntArray1578[i_32_ + i_30_] * (long) Class12.anInt237 >> 16);
					for (int i_35_ = 0; i_35_ < i_30_; i_35_++)
						i_34_ += (int) ((long) anIntArray1578[i_32_ + i_30_ - 1 - i_35_] * (long) Class12.anIntArrayArray233[0][i_35_] >> 16);
					for (int i_36_ = 0; i_36_ < i_32_; i_36_++)
						i_34_ -= (int) ((long) anIntArray1578[i_32_ - 1 - i_36_] * (long) Class12.anIntArrayArray233[1][i_36_] >> 16);
				...
				for (;;) {
					...
					for (/**/; i_32_ < i_33_; i_32_++) {
						int i_37_ = (int) ((long) anIntArray1578[i_32_ + i_30_] * (long) Class12.anInt237 >> 16);
						for (int i_38_ = 0; i_38_ < i_30_; i_38_++)
							i_37_ += (int) ((long) anIntArray1578[i_32_ + i_30_ - 1 - i_38_] * (long) Class12.anIntArrayArray233[0][i_38_] >> 16);
						for (int i_39_ = 0; i_39_ < i_31_; i_39_++)
							i_37_ -= (int) ((long) anIntArray1578[i_32_ - 1 - i_39_] * (long) Class12.anIntArrayArray233[1][i_39_] >> 16);
					...
					i_30_ = aClass12_1581.method114(0, (float) i_29_ / 65536.0F);
					i_31_ = aClass12_1581.method114(1, (float) i_29_ / 65536.0F);
					i_33_ += 128;
				}
				for (/**/; i_32_ < i; i_32_++) {
					int i_40_ = 0;
					for (int i_41_ = i_32_ + i_30_ - i; i_41_ < i_30_; i_41_++)
						i_40_ += (int) ((long) anIntArray1578[i_32_ + i_30_ - 1 - i_41_] * (long) Class12.anIntArrayArray233[0][i_41_] >> 16);
					for (int i_42_ = 0; i_42_ < i_31_; i_42_++)
						i_40_ -= (int) ((long) anIntArray1578[i_32_ - 1 - i_42_] * (long) Class12.anIntArrayArray233[1][i_42_] >> 16);
	...
	static {
		...
		for (int i = 0; i < 32768; i++)
			anIntArray1593[i] = (int) (Math.sin((double) i / 5215.1903) * 16384.0);
