			...
			while_31_:
				...
				while_30_:
					...
					while_29_:
						do {
							do {
								if (i_66_ != 0) {
									...
									aBoolean3092 = class23_sub5.readByte() == 1;
									return;
								}
								anInt3079 = class23_sub5.readByte();
								return;
							} while (false);
						...
						anInt3094 = anInt3081 = class23_sub5.readByte();
						return;
					} while (false);
					anInt3093 = class23_sub5.readByte();
					return;
				} while (false);
				anInt3094 = class23_sub5.readByte();
				return;
			} while (false);
			anInt3081 = class23_sub5.readByte();
		} while (false);
	}
