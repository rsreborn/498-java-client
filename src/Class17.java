...
abstract class Class17
{
	...
	static final void method190(byte[] bs, int i) {
		...
		int i_4_ = class23_sub5.method476((byte) -121);
		for (int i_5_ = 0; i_4_ > i_5_; i_5_++) {
			Class23_Sub21 class23_sub21 = new Class23_Sub21();
			RSString class16 = class23_sub5.method426(2);
			class23_sub21.anInt2412 = class23_sub5.method476((byte) -117);
			class23_sub21.anInt2415 = class23_sub5.method476((byte) -120);
			class23_sub21.anInt2405 = class23_sub5.method461(-1797813752);
