...
public class Class101
{
	...
	private static final int method1507(int[] is, int i) {
		int i_12_ = is[i];
		int i_13_ = -1;
	...
	private final int method1508(int i, int i_17_, int i_18_, int i_19_, int i_20_) {
	...
	private final void method1509(int i, int i_26_, int i_27_, int i_28_, float[] fs, int i_29_) {
	...
	private static final int method1511(int[] is, int i) {
		int i_54_ = is[i];
		int i_55_ = -1;
	...
	private final void method1512(int i, int i_59_) {
		if (i < i_59_) {
			int i_60_ = i;
