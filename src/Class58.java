...
public class Class58
{
	...
	static final void parsePlayerSyncMasks(boolean bool, int i, Class38_Sub7_Sub2 class38_sub7_sub2, int i_0_) {
		...
		if ((0x400 & i_0_ ^ 0xffffffff) != -1) {
			class38_sub7_sub2.anInt2710 = Class23_Sub13_Sub4.inBuffer.method453(65280);
			int i_1_ = Class23_Sub13_Sub4.inBuffer.method465((byte) -127);
		...
		if ((0x40 & i_0_ ^ 0xffffffff) != -1) {
			int i_2_ = Class23_Sub13_Sub4.inBuffer.getLEShortA(123);
			int i_3_ = Class23_Sub13_Sub4.inBuffer.readUByte();
			int i_4_ = Class23_Sub13_Sub4.inBuffer.method458(125);
			int i_5_ = Class23_Sub13_Sub4.inBuffer.pos;
			...
			if (class38_sub7_sub2.aClass16_4389 != null && class38_sub7_sub2.aClass51_4393 != null) {
				...
				if (!bool_7_ && (Class23_Sub4_Sub39.anInt3519 ^ 0xffffffff) == -1) {
					...
					Class23_Sub13_Sub4.inBuffer.method478(-1, 0, i_4_, Class23_Sub24.aClass23_Sub5_2445.payload);
					Class23_Sub24.aClass23_Sub5_2445.pos = 0;
					RSString class16;
					if (bool_6_) {
						i_2_ &= 0x7fff;
			...
			Class23_Sub13_Sub4.inBuffer.pos = i_4_ + i_5_;
		}
		if ((i_0_ & 0x80) != 0) {
			int i_10_ = Class23_Sub13_Sub4.inBuffer.getUByte(-112);
			int i_11_ = Class23_Sub13_Sub4.inBuffer.method435((byte) 121);
			class38_sub7_sub2.method1086(10, i_10_, i_11_, Class89.anInt1511);
			class38_sub7_sub2.anInt2638 = Class89.anInt1511 - -300;
			class38_sub7_sub2.anInt2708 = Class23_Sub13_Sub4.inBuffer.readUByte();
		}
		if ((0x10 & i_0_ ^ 0xffffffff) != -1) {
			class38_sub7_sub2.aClass16_2670 = Class23_Sub13_Sub4.inBuffer.readString(2);
		...
		if ((0x1 & i_0_) != 0) {
			int i_12_ = Class23_Sub13_Sub4.inBuffer.getUShortBE();
			int i_13_ = Class23_Sub13_Sub4.inBuffer.getUByte(-111);
		...
		if (bool == true) {
			if ((0x20 & i_0_) != 0) {
				class38_sub7_sub2.anInt2686 = Class23_Sub13_Sub4.inBuffer.method480((byte) 82);
				if ((class38_sub7_sub2.anInt2686 ^ 0xffffffff) == -65536) {
					class38_sub7_sub2.anInt2686 = -1;
				}
			}
			if ((0x4 & i_0_) != 0) {
				class38_sub7_sub2.anInt2648 = Class23_Sub13_Sub4.inBuffer.method480((byte) 82);
				class38_sub7_sub2.anInt2692 = Class23_Sub13_Sub4.inBuffer.getUShortBE();
			}
			if ((i_0_ & 0x100) != 0) {
				class38_sub7_sub2.anInt2650 = Class23_Sub13_Sub4.inBuffer.method435((byte) 86);
				class38_sub7_sub2.anInt2688 = Class23_Sub13_Sub4.inBuffer.readUByte();
				class38_sub7_sub2.anInt2633 = Class23_Sub13_Sub4.inBuffer.getUByte(-100);
				class38_sub7_sub2.anInt2681 = Class23_Sub13_Sub4.inBuffer.method435((byte) 80);
				class38_sub7_sub2.anInt2684 = Class23_Sub13_Sub4.inBuffer.getUShortBE() - -Class89.anInt1511;
				class38_sub7_sub2.anInt2716 = Class23_Sub13_Sub4.inBuffer.method480((byte) 82) - -Class89.anInt1511;
				class38_sub7_sub2.anInt2717 = Class23_Sub13_Sub4.inBuffer.method458(127);
				class38_sub7_sub2.anInt2660 = 1;
				class38_sub7_sub2.anInt2640 = 0;
			}
			if ((0x200 & i_0_) != 0) {
				int i_14_ = Class23_Sub13_Sub4.inBuffer.readUByte();
				int i_15_ = Class23_Sub13_Sub4.inBuffer.readUByte();
				class38_sub7_sub2.method1086(10, i_14_, i_15_, Class89.anInt1511);
			}
			if ((i_0_ & 0x2) != 0) {
				int i_16_ = Class23_Sub13_Sub4.inBuffer.readUByte();
				byte[] bs = new byte[i_16_];
				Buffer class23_sub5 = new Buffer(bs);
				Class23_Sub13_Sub4.inBuffer.readBytes(bs, 0, i_16_);
