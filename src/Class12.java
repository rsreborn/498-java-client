...
public class Class12
{
	...
	final void method117(Buffer class23_sub5, Class41 class41) {
		...
		if (i != 0) {
			anIntArray238[0] = class23_sub5.getUShortBE();
			anIntArray238[1] = class23_sub5.getUShortBE();
			int i_13_ = class23_sub5.readUByte();
			for (int i_14_ = 0; i_14_ < 2; i_14_++) {
				for (int i_15_ = 0; i_15_ < anIntArray236[i_14_]; i_15_++) {
					anIntArrayArrayArray235[i_14_][0][i_15_] = class23_sub5.getUShortBE();
					anIntArrayArrayArray232[i_14_][0][i_15_] = class23_sub5.getUShortBE();
				}
			}
			for (int i_16_ = 0; i_16_ < 2; i_16_++) {
				for (int i_17_ = 0; i_17_ < anIntArray236[i_16_]; i_17_++) {
					if ((i_13_ & 1 << i_16_ * 4 << i_17_) != 0) {
						anIntArrayArrayArray235[i_16_][1][i_17_] = class23_sub5.getUShortBE();
						anIntArrayArrayArray232[i_16_][1][i_17_] = class23_sub5.getUShortBE();
					} else {
