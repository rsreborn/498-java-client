						...
						do {
							do {
								if ((i_1_ ^ 0xffffffff) != -1) {
									...
									anInt3485 = anInt3491 = class23_sub5.readByte();
									break while_157_;
								}
								anInt3473 = class23_sub5.readByte();
								break while_157_;
							} while (false);
							anInt3474 = class23_sub5.readShortBE();
							break while_157_;
						} while (false);
						anInt3483 = class23_sub5.readByte();
						break while_157_;
					} while (false);
					anInt3495 = class23_sub5.readByte();
					break while_157_;
				} while (false);
				anInt3485 = class23_sub5.readByte();
				break while_157_;
			} while (false);
			anInt3491 = class23_sub5.readByte();
		} while (false);
		anInt3477++;
	}
