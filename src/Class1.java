	...
	Class1(Buffer class23_sub5) {
		...
		for (int i_37_ = 0; (i_37_ ^ 0xffffffff) > (i ^ 0xffffffff); i_37_++) {
			...
			for (int i_39_ = 0; i_38_ > i_39_; i_39_++)
				is[i_37_][i_39_] = class23_sub5.readByte();
		...
		Object object = null;
		aClass23_Sub4_56 = aClass23_Sub4Array57[class23_sub5.readByte()];
		aClass23_Sub4_60 = aClass23_Sub4Array57[class23_sub5.readByte()];
	}
