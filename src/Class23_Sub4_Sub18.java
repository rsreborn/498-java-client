...
public class Class23_Sub4_Sub18 extends Class23_Sub4
{
	...
	static final void method339(int i, int i_4_, int i_5_, int i_6_) {
		...
		Class23_Sub13_Sub7.aBoolean3792 = true;
		if (i == 5087) {
			...
			do {
				do {
					if ((i_17_ ^ 0xffffffff) != -1) {
						...
						anInt3187 = class23_sub5.method461(i_16_ + -1797814752);
						break while_47_;
					}
					anInt3182 = class23_sub5.method476((byte) -111);
					break while_47_;
				} while (false);
				anInt3192 = class23_sub5.method461(i_16_ + -1797814752);
			} while (false);
			anInt3181++;
		}
	}
