	...
	static final void method608(Class23_Sub5_Sub1 class23_sub5_sub1, int i, byte b) {
		...
		if (b == 35) {
			for (;;) {
				...
				class23_sub5_sub1.writeOpcode(i, b ^ 0xb83);
				class23_sub5_sub1.writeByte(0);
				int i_19_ = class23_sub5_sub1.pos;
				class23_sub5_sub1.putInt(class23_sub27.anInt2478, b ^ ~0x43d2e3c4);
							...
							if (i_21_ != 0) {
								if (i_21_ != 1) {
									if (i_21_ == 2) {
										...
										class23_sub5_sub1.writeByte(0);
										class23_sub5_sub1.putInt(i_22_, b + -1137894411);
									}
								} else {
									Field field = (Field) class23_sub27.aClass60Array2484[i_20_].anObject955;
								...
								class23_sub5_sub1.writeByte(0);
								class23_sub5_sub1.putInt(i_23_, b + -1137894411);
							}
							if (i_21_ != 3) {
								if (i_21_ == 4) {
									...
									class23_sub5_sub1.writeByte(0);
									class23_sub5_sub1.putInt(i_24_, -1137894376);
								}
							} else {
								Method method = (Method) class23_sub27.aClass60Array2477[i_20_].anObject955;
								...
								if (object == null) {
									...
									class23_sub5_sub1.putLong(((Number) object).longValue(), (byte) -111);
								}
							}
				...
				class23_sub5_sub1.method477((byte) 21, -i_19_ + class23_sub5_sub1.pos);
