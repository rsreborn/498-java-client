...
public class Class14
{
	...
	static final void method129(byte[] bs, int i) {
		...
		class23_sub5.pos = bs.length - 2;
		Class23_Sub4_Sub20.anInt3229 = class23_sub5.getUShortBE();
		...
		class23_sub5.pos = -(8 * Class23_Sub4_Sub20.anInt3229) + -7 + bs.length;
		Class23_Sub12.anInt2301 = class23_sub5.getUShortBE();
		Class23_Sub13_Sub15.anInt4033 = class23_sub5.getUShortBE();
		int i_3_ = (class23_sub5.readUByte() & 0xff) + 1;
		for (int i_4_ = 0; (i_4_ ^ 0xffffffff) > (Class23_Sub4_Sub20.anInt3229 ^ 0xffffffff); i_4_++)
			Class23_Sub23.anIntArray2417[i_4_] = class23_sub5.getUShortBE();
		for (int i_5_ = 0; (i_5_ ^ 0xffffffff) > (Class23_Sub4_Sub20.anInt3229 ^ 0xffffffff); i_5_++)
			Class23_Sub13_Sub2.anIntArray3679[i_5_] = class23_sub5.getUShortBE();
		for (int i_6_ = 0; (i_6_ ^ 0xffffffff) > (Class23_Sub4_Sub20.anInt3229 ^ 0xffffffff); i_6_++)
			Class79.anIntArray1875[i_6_] = class23_sub5.getUShortBE();
		for (int i_7_ = 0; Class23_Sub4_Sub20.anInt3229 > i_7_; i_7_++)
			Class105.anIntArray1766[i_7_] = class23_sub5.getUShortBE();
		class23_sub5.pos = -(Class23_Sub4_Sub20.anInt3229 * 8) + (bs.length + (-7 - (i_3_ - 1) * 3));
		Class23_Sub4_Sub1.anIntArray2890 = new int[i_3_];
		for (int i_8_ = i; i_8_ < i_3_; i_8_++) {
			Class23_Sub4_Sub1.anIntArray2890[i_8_] = class23_sub5.getTriByte(Class104.method1531(i, 67));
