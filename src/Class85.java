...
{
	private static Class74 aClass74_1480 = new Class74();
	
	private static final void method1390(Class74 class74) {
		byte b = class74.aByte1348;
		int i = class74.anInt1347;
		int i_0_ = class74.anInt1342;
		int i_1_ = class74.anInt1333;
		int[] is = Class38_Sub7_Sub2.anIntArray4412;
	...
	private static final byte method1391(Class74 class74) {
		return (byte) method1394(1, class74);
	}
	
	private static final byte method1392(Class74 class74) {
		return (byte) method1394(8, class74);
	}
	
	private static final void method1393(Class74 class74) {
		class74.anInt1368 = 0;
		for (int i = 0; i < 256; i++) {
	...
	private static final int method1394(int i, Class74 class74) {
		int i_10_;
		for (;;) {
	...
	static final int method1395(byte[] bs, int i, byte[] bs_12_, int i_13_, int i_14_) {
	...
	private static final void method1397(Class74 class74) {
		boolean bool = false;
		...
		int[] is_33_ = null;
		class74.anInt1365 = 1;
		if (Class38_Sub7_Sub2.anIntArray4412 == null) {
			Class38_Sub7_Sub2.anIntArray4412 = new int[class74.anInt1365 * 100000];
		}
		...
		while (bool_34_) {
			...
			while (i_68_ != i_56_) {
				if (i_68_ == 0 || i_68_ == 1) {
					...
					for (/**/; i_69_ > 0; i_69_--) {
						Class38_Sub7_Sub2.anIntArray4412[i_63_] = i_35_ & 0xff;
						i_63_++;
					}
				} else {
					int i_72_ = i_68_ - 1;
					...
					Class38_Sub7_Sub2.anIntArray4412[i_63_] = class74.aByteArray1341[b & 0xff] & 0xff;
					i_63_++;
					if (i_58_ == 0) {
						i_57_++;
						i_58_ = 50;
			...
			for (int i_84_ = 0; i_84_ < i_63_; i_84_++) {
				i_35_ = (byte) (Class38_Sub7_Sub2.anIntArray4412[i_84_] & 0xff);
				Class38_Sub7_Sub2.anIntArray4412[class74.anIntArray1359[i_35_ & 0xff]] |= i_84_ << 8;
				class74.anIntArray1359[i_35_ & 0xff]++;
			}
			class74.anInt1371 = Class38_Sub7_Sub2.anIntArray4412[class74.anInt1338] >> 8;
			class74.anInt1342 = 0;
			class74.anInt1371 = Class38_Sub7_Sub2.anIntArray4412[class74.anInt1371];
	...
	private static final void method1398(int[] is, int[] is_85_, int[] is_86_, byte[] bs, int i, int i_87_, int i_88_) {
		int i_89_ = 0;
