...
public class Class77
{
	...
	private float[][] aFloatArrayArray1403;
	protected int anInt1404;
	private int[] anIntArray1405;
	private int[] anIntArray1406;
	...
	private static final int method1339(int i, int i_0_) {
		int i_1_;
		for (i_1_ = (int) Math.pow((double) i, 1.0 / (double) i_0_) + 1; Class23_Sub4_Sub11.method306(115, i_0_, i_1_) > i; i_1_--) {
			/* empty */
		}
		return i_1_;
	}
			...
			if (i == 1) {
				for (int i_29_ = 0; i_29_ < anInt1401; i_29_++) {
					...
					for (int i_32_ = 0; i_32_ < anInt1404; i_32_++) {
						...
						float f_34_ = (float) anIntArray1405[i_33_] * f_24_ + f + f_30_;
				...
				for (int i_35_ = 0; i_35_ < anInt1401; i_35_++) {
					...
					for (int i_38_ = 0; i_38_ < anInt1404; i_38_++) {
						float f_39_ = (float) anIntArray1405[i_37_] * f_24_ + f + f_36_;
