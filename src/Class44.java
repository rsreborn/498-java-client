...
public class Class44
{
	...
	static final void method1128(int i) {
		...
		if ((Class23_Sub4_Sub31.anInt3400 ^ 0xffffffff) < -1) {
			...
			NPCDefinition.aClass34_4150 = Class23_Sub24.aClass34_2440;
	...
	static final void method1129(int i, int i_3_, byte b) {
		anInt675++;
		Class89 class89 = Class82.aClass89ArrayArrayArray1453[ItemDefinition.anInt3916][i][i_3_];
		if (class89 == null) {
			Class29.method949(ItemDefinition.anInt3916, i, i_3_);
		} else {
			int i_4_ = -99999999;
			...
			for (/**/; class23_sub13_sub1 != null; class23_sub13_sub1 = (Class23_Sub13_Sub1) class89.method1431((byte) -89)) {
				ItemDefinition class23_sub13_sub11 = Class23_Sub13_Sub24.method853(123, class23_sub13_sub1.aClass38_Sub2_3668.anInt2495);
			...
			if (class23_sub13_sub1_5_ == null) {
				...
				Class39.method1103(ItemDefinition.anInt3916, i, i_3_, Class23_Sub4_Sub22.method359(ItemDefinition.anInt3916, 64 + i * 128, 64 + 128 * i_3_, (byte) -52), class23_sub13_sub1_5_.aClass38_Sub2_3668, l, class38_sub2, class38_sub2_7_);
			}
		}
	}
